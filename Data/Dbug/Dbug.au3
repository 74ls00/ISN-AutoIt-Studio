...
$DBGhSci = ControlGetHandle($title,"",ptr(RegRead("HKEY_CURRENT_USER\Software\ISN AutoIt Studio", "Dbug_Sci_Handle")))	;Scintilla handle
...
;~ 		If $CmdLine[0] = 0 Or BitAND($val, 0x0002) = 2 Or $DBGstepMode Or $DBGLineFun[$lnr-1] = $DBGBreakFun Or $lnr = $DBGBreakLine Or $breaknow Then
		If BitAND($val, 0x0002) = 2 Or $DBGstepMode Or $DBGLineFun[$lnr-1] = $DBGBreakFun Or $lnr = $DBGBreakLine Or $breaknow Then
